...
class _HomeState extends State<Home> {
  ...
  List<String> workoutsImages = [
    "assets/welcomePage/intermediate.png",
    "assets/welcomePage/advanced.png",
  ];
  @override
            ...
            body: Column(
              ...
              children: [
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Row(
                          children: [
                            Text("יום " + getDayFromEngDay() , style: assistantStyle(Colors.grey[600]!,17),),
                            SizedBox(width: 10,),
                            Text(dateToday.toString().split("-")[2].split(" ")[0] +" / "+ (dateToday.toString().split("-")[1][0] == "0" ?dateToday.toString().split("-")[1].substring(1) :  dateToday.toString().split("-")[1]) +" / "+  dateToday.toString().split("-")[0]  , style: assistantStyle(Colors.grey[600]!,17),),
                          ],
                        ),
                        Row(
                          children: [
                            simpleText(Colors.white, 20, "שלום לך, "),
                            SizedBox(width: 10,),
                            simpleText(greenClr, 20, gymHeroUser.name),
                          ],
                        ),
                    ...
                    Container(
                      ...
                      child: Icon(Icons.account_circle,color: Colors.white,size: 65,),
                    ),
                    SizedBox(width: 20,),
                  ],
                ),
                ...
                Row(
                  children: [
                    SizedBox(width: 20,),
                    simpleText(greenClr, 15, "תוכניות מומלצות למתחילים"),
                  ],
                ),
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                                image: AssetImage(workoutsImages[0]),fit: BoxFit.fill
                            )
                        ),
                      ),
                    ),
                Padding(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(20),
                        image: DecorationImage(
                            image: AssetImage(workoutsImages[1]),fit: BoxFit.fill
                        )
                    ),
                  ),
                ),
